...
GLITCH_STRICTLY_MORE_THAN_HALF_ONES: Final = True   # printings disagree; contract picks "more than half"
...
BLACKBOARD_KEYS: Final = (
    "target", "last_known_pos", "home_pos", "cover_pos", "noise_pos",
    "alert_level", "morale", "objective", "pacified",
    "command_target", "summoner_id", "rounds_bound",
)
